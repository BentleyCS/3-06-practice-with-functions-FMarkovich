...
def multiplyDifferences(a,b,c,d):
    multiplyDifferences=(a*(a-b)*(a-c)*(a-d))
    return multiplyDifferences
...
def quadratic(a,b,c):
    (plusMinus(a,b)-root(mainCalc(a,b,c)))/denominator(a)
